...
export default function Analytics() {
  ...
  const stats = [
    { label: "Total Revenue", value: formatCurrency(currentRevenue, BASE_CURRENCY), change: revenueChange, trend: revenueChange.startsWith("+") || revenueChange === "N/A" ? "up" : "down", icon: DollarSign, color: "from-[#2d5a3d] to-[#0b7c33]" },
    ...
    { label: "Avg Order Value", value: formatCurrency(avgOrderValue, BASE_CURRENCY), change: avgOrderChange, trend: avgOrderChange.startsWith("+") || avgOrderChange === "N/A" ? "up" : "down", icon: TrendingUpIcon, color: "from-[#68d391] to-[#4a9d7a]" },
  ];
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={chartData}>
                    ...
                    <XAxis 
                      ...
                      stroke="#78746e" 
                    />
                    <YAxis stroke="#78746e" tickFormatter={(value) => formatCurrency(value, BASE_CURRENCY)} />
                    <Tooltip 
                      contentStyle={{ backgroundColor: "white", border: "1px solid #2d5a3d20", borderRadius: "8px" }}
                      formatter={(value: number) => [formatCurrency(value, BASE_CURRENCY), "Revenue"]}
                    />
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={productPerformance}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="revenue" fill="#2d5a3d" name={`Revenue (${BASE_CURRENCY})`} radius={[4, 4, 0, 0]} />
